...
namespace renderer
{
	...
	ni::graphics::ConstantBuffer* constantBuffer[(UINT)eCBType::End] = {};
	...
	ni::Camera* mainCamera = nullptr;
	std::vector<ni::Camera*> cameras = {};
...
#pragma region InputLayout
		...
		std::shared_ptr<Shader> shader = ni::Resources::Find<Shader>(L"TriangleShader");
		ni::graphics::GetDevice()->CreateInputLayout(arrLayout, 3
			, shader->GetVSCode()
			, shader->GetInputLayoutAddressOf());

		shader = ni::Resources::Find<Shader>(L"SpriteShader");
		ni::graphics::GetDevice()->CreateInputLayout(arrLayout, 3
			, shader->GetVSCode()
			, shader->GetInputLayoutAddressOf());
...
#pragma endregion
	...
	void LoadShader()
	{
		...
		ni::Resources::Insert(L"TriangleShader", shader);
